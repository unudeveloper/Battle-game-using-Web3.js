...
export default class MechAIPlayer extends MechPlayer {
    ...
    public constructor(k: KaboomCtx,
        name: string,
        spriteNum: number,
        color: string,
        gun: string,
        ...
        const AIstates = k.state("move", [ "idle", "move", "jump", "attack", "shield"]);
        super(k, name, spriteNum, color, gun, facing, mainTag, tags, startPosX, startPosY, new NullInputSource(), AIstates);
        this.initAI(this.obj);
        this.obj.enterState("move");          
    }
